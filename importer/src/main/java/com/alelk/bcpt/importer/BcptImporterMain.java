...
/**
 * Bcpt Importer Main (for the development testing)
 *
...
public class BcptImporterMain {
    ...
    public static void main(String[] args) {
        ...
        Flowable<Progress<BcptDtoBundle>> flow = importer.parseDbf(new File("/bc-data/база-данных-1.txt")).subscribeOn(Schedulers.io());
        ...
        flow.takeLast(1).subscribe(pr -> {
            ...
            sleep(10000);
            importer.saveBundle(pr.getResult())
